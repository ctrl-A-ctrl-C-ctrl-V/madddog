<div align="center">
  <img src="madddog_logo.png" alt="MADDDOG Logo" width="400">
</div>
...
* **AI-Powered Editing:** Built-in support for **llama-3.3-70b-versatile**, **llama-3.1-8b-instant** (via Groq), and **Google Gemini**.
...
| **Run model** | llama-3.3-70b-versatile | Switches the editor mode to the Llama 3.3 70B model. |
| | llama-3.1-8b-instant | Switches the editor mode to the Llama 3.1 8B model. |
| | Gemini | Switches the editor mode to the Gemini model. |
...
* **Table Rendering Fix:** Standard Markdown table tags (`<table>`, `<th>`, `<td>`) are dynamically injected with inline CSS properties at runtime to guarantee crisp grids and proper cell alignment within the `tkhtmlview` preview engine.
